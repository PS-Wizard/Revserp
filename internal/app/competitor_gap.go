...
func (a *App) loadCompetitorGapReport(w http.ResponseWriter, r *http.Request) (sqlc.GetCrawlByIDForUserRow, competitorgaps.Report, bool) {
	...
	if !featuresFromRow(featuresRow.AutoCrawl, featuresRow.GscConnector, featuresRow.AiChat, featuresRow.Integrations, featuresRow.AiUseInternalPrompt, featuresRow.AiMonthlyMessageLimit, featuresRow.AiConcurrentTurnLimitPerUser, featuresRow.MaxCompetitors, featuresRow.MaxProjects, featuresRow.AiAllowedReasoningEfforts).Enabled(FeatureCompetitors) {
