...
func TestRenderChartRegistryOrder(t *testing.T) {
	...
	want := []string{"read_issues", "get_score_summary", "get_search_console_data", "get_business_profile", "read_issue_work", "read_page", "render_chart", "update_business_profile", "web_search", "get_search_suggestions", "fetch_url"}
